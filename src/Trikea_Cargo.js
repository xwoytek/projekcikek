...
import vid from "./img/trikeacargovid.mp4";
    ...
    <div className="bg">
      ...
      <div className="maincontent">
        ...
        <div className="corpotekst">
          <h1>
            Trikea Cargo specjalizuje się w kompleksowych rozwiązaniach
            logistycznych z wykorzystaniem transportu lotniczego. Naszym
            priorytetem jest dostarczanie niezawodnych, szybkich i ekonomicznych
            usług, które wspierają rozwój naszych partnerów biznesowych. W
            Trikea Cargo stawiamy na innowacje oraz nowoczesne technologie, aby
          ...
          <h2>
            ...
            logistycznych przy użyciu nowoczesnych samolotów towarowych. Naszym
            celem jest stanie się liderem w branży logistycznej, znanym z
            wyjątkowej jakości usług i zaufania naszych klientów.
          </h2>
          <div className="przerwa"></div>
          <h3>
            Dysponujemy nowoczesną flotą samolotów oraz zespołem doświadczonych
          ...
          <div className="przerwa"></div>
          <h4>
            W Trikea Cargo wierzymy, że nasza pasja do logistyki oraz
            zaangażowanie w doskonałość pomagają naszym klientom osiągać ich
            cele biznesowe. Niedawno wprowadziliśmy nowe rozwiązania
            technologiczne, które obejmują wykorzystanie precyzyjnych systemów
            kierowanych laserowo i zaawansowanych technologii naprowadzania
            radarowego, aby zapewnić jeszcze większą dokładność i bezpieczeństwo
            naszych operacji logistycznych. Te nowoczesne technologie
            umożliwiają nam jeszcze skuteczniejsze i bardziej bezpieczne
            dostarczanie ładunków na całym świecie.
          </h4>
        </div>
